...
enum _SuperadminPage { inventory, sleeper, actions, audit, requests, permission }
...
/// INVENTORY | ACTIONS | AUDIT | REQUESTS | PERMISSION and is hidden while
/// inside the Sleeper inventory experience.
...
class _SuperadminShellState extends State<SuperadminShell> {
  ...
  bool get _inSleeperExperience => _page == _SuperadminPage.sleeper;
  ...
  void _go(_SuperadminPage page) {
    setState(() {
      ...
      } else if (page == _SuperadminPage.sleeper) {
        widget.inventoryController.setSection(
  ...
  Widget _buildBody(InventoryController controller) {
    switch (_page) {
      ...
      case _SuperadminPage.permission:
        return const SuperadminPermissionView();
    }
  }
            ...
            child: ListView(
              ...
              children: [
                ...
                _DrawerItem(
                  ...
                  label: 'SLEEPER',
                  active: _page == _SuperadminPage.sleeper,
                  onTap: () => _go(_SuperadminPage.sleeper),
                ),
              ],
            ),
          ),
          ...
          child: Row(
            children: [
              _NavItem(
                ...
                isActive: _page == _SuperadminPage.inventory,
                onTap: () =>
                    setState(() => _page = _SuperadminPage.inventory),
              ),
              _NavItem(
                label: 'ACTIONS',
                icon: Icons.add_box_outlined,
                activeIcon: Icons.add_box,
                isActive: _page == _SuperadminPage.actions,
                onTap: () => setState(() => _page = _SuperadminPage.actions),
              ),
              _NavItem(
                label: 'AUDIT',
                icon: Icons.receipt_long_outlined,
                activeIcon: Icons.receipt_long,
                isActive: _page == _SuperadminPage.audit,
                onTap: () => setState(() => _page = _SuperadminPage.audit),
              ),
              _NavItem(
                label: 'REQUESTS',
                icon: Icons.outbox_outlined,
                activeIcon: Icons.outbox,
                isActive: _page == _SuperadminPage.requests,
                onTap: () => setState(() => _page = _SuperadminPage.requests),
              ),
              _NavItem(
                label: 'PERMISSION',
                icon: Icons.admin_panel_settings_outlined,
                activeIcon: Icons.admin_panel_settings,
                isActive: _page == _SuperadminPage.permission,
                onTap: () =>
                    setState(() => _page = _SuperadminPage.permission),
              ),
            ],
          ),
        ),
